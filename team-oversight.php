...
define('TEAM_OVERSIGHT_VERSION', '1.55.0');
...
function team_oversight_init() {
    ...
    require_once TEAM_OVERSIGHT_PLUGIN_DIR . 'includes/class-log.php';
    ...
    require_once TEAM_OVERSIGHT_PLUGIN_DIR . 'includes/class-trial-emails.php';
