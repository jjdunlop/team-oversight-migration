...
- **Transfer chip** on applicant and selection-roster cards: players transferring from another club show a compact "⇄ [previous club]" chip (truncated for long names, full detail on hover) so coaches can factor VV transfer paperwork into selections at a glance.
