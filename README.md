...
- Competition (men's/women's) derives from profile gender; the question is only asked when the profile can't answer (unset/non-binary). The team list leads with the applicant's own competition, so a women's-competition player sees Women's Teams first rather than scrolling past a greyed-out men's block.
